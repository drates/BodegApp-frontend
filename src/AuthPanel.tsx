...
// 🟢 CAMBIO 1: Definir la interfaz de propiedades
interface AuthPanelProps {
    defaultMode: 'login' | 'register';
}

// Opciones de negocio para el selector de registro.
...
// 🟢 CAMBIO 2: Aceptar la prop 'defaultMode'
function AuthPanel({ defaultMode }: AuthPanelProps) {
    ...
    // 🟢 CAMBIO 3: Inicializar isLoginMode usando la prop defaultMode
    const [isLoginMode, setIsLoginMode] = useState(defaultMode === 'login');
    const [email, setEmail] = useState('');
    const [password, setPassword] = useState('');
    const [nombreEmpresa, setNombreEmpresa] = useState('');
    // Usamos el primer tipo de negocio como valor inicial si no estamos en login
    const [tipoNegocio, setTipoNegocio] = useState(tipoNegocioOptions[0]);
    ...
    // ⬇️ ESTILOS ORIGINALES MANTENIDOS ⬇️
